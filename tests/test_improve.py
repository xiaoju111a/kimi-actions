        ...
        suggestions = [
            {
                "relevant_file": "test.py",
                "severity": "low",
                "one_sentence_summary": "Minor",
            }
        ]
        summary = improve._format_summary(
            suggestions, 1, command_quote="/improve --all"
        )
    ...
    def test_format_summary_severity_sorting(self, mock_action_config):
        ...
        suggestions = [
            {"relevant_file": "a.py", "severity": "low", "one_sentence_summary": "Low"},
            {
                "relevant_file": "b.py",
                "severity": "critical",
                "one_sentence_summary": "Critical",
            },
            {
                "relevant_file": "c.py",
                "severity": "medium",
                "one_sentence_summary": "Medium",
            },
        ]
...
```"""
                ...
                assert (
                    "Kimi Code Suggestions" in result or "suggestions" in result.lower()
                )
