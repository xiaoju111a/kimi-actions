...
class TestDescribePRGeneration:
    ...
    def test_run_generates_description(self, mock_asyncio, mock_github, mock_pr, mock_config):
...
```"""
    ...
    @patch('tools.describe.asyncio.run')
    def test_run_without_label_generation(self, mock_asyncio, mock_github, mock_pr, mock_config):
...
```"""
    ...
    @patch('tools.describe.asyncio.run')
    def test_run_handles_update_error(self, mock_asyncio, mock_github, mock_pr, mock_config):
